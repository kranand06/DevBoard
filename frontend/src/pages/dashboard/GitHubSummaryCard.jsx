...
export default function GitHubSummaryCard() {
  ...
  return (
    ...
    <BentoCard className="md:col-span-8 p-8 flex flex-col min-h-[360px]">
      {/* Header */}
      <div className="flex justify-between items-start mb-8">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-[#222a3d] flex items-center justify-center border border-[#464554]">
            <svg className="w-6 h-6 fill-[#dae2fd]" viewBox="0 0 24 24">
        ...
        {repos.map((r) => (
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <span className="text-[14px] font-semibold text-[#dae2fd] group-hover:text-[#c0c1ff] transition-colors">
                {r.name}
              </span>
